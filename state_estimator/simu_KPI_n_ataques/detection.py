...
for c in ['090neg', '090pos', '100pos']:    
    ...
    for hour in ['10']:                          
        ...
        #     }
        count = lib.detection(lambda_value = lambda_value, n_simus = n_simus, names = names, net_base = net, range_n_att=range_n_att, bandas = bandas)
        
        
        resultados[c][hour] = count


with open('detection_15_20.json', 'w') as json_file:
