...
Meas[num]['value'] = 1.02*Meas[num]['value']
######################################################################
######################################################################
...
#     else:       
#         if Meas[num]['type'] == 'U':
#             Meas[num]['value'] = 0.97*Meas[num]['value']
#         else:
#             Meas[num]['value'] = 0.8*Meas[num]['value']
...
# Máximo residuo (normal) antes de descartar ninguna medida  -> ajustamos lambda
