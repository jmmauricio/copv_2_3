    ...
    for index_banda_2, banda_2 in enumerate(bandas_array):    
        ...
        for c in ['090neg', '090pos', '100pos']:    
            ...
            for hour in ['10']:                          
                ...
                n_simus = 100
                count = lib.detection(lambda_value = lambda_value, n_simus = n_simus, names = names, net_base = net, banda1 = banda_1, banda2 = banda_2)
                
                
                resultados[c][hour] = count
        
        
        with open('detection_' + str(index_banda_1) + '_' + str(index_banda_2) + '.json', 'w') as json_file:
