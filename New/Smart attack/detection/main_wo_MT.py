...
Res = {
       '5' : {'0': {'Detection': []}, '1': {'Detection': []}, '2': {'Detection': []}, '3': {'Detection': []}, '4': {'Detection': []}, 
              '5': {'Detection': []}, '6': {'Detection': []}, '7': {'Detection': []}, '8': {'Detection': []}, '9': {'Detection': []}},
       '10': {'0': {'Detection': []}, '1': {'Detection': []}, '2': {'Detection': []}, '3': {'Detection': []}, '4': {'Detection': []}, 
              '5': {'Detection': []}, '6': {'Detection': []}, '7': {'Detection': []}, '8': {'Detection': []}, '9': {'Detection': []}},
       '20': {'0': {'Detection': []}, '1': {'Detection': []}, '2': {'Detection': []}, '3': {'Detection': []}, '4': {'Detection': []}, 
              '5': {'Detection': []}, '6': {'Detection': []}, '7': {'Detection': []}, '8': {'Detection': []}, '9': {'Detection': []}},
       '40': {'0': {'Detection': []}, '1': {'Detection': []}, '2': {'Detection': []}, '3': {'Detection': []}, '4': {'Detection': []}, 
              '5': {'Detection': []}, '6': {'Detection': []}, '7': {'Detection': []}, '8': {'Detection': []}, '9': {'Detection': []}},
      }          
    ...
    for scenario in range(10):
        ...
        while n_simu < 20:
            ...
            try:
                ...
                res_woMT = net_woMT.state_estimation(tol = 1e-4, 
                                                     niter = 50, 
                                                     Huber = True, 
                                                     lmb = 2.5, 
                                                     rn = False)
                ...
                ident_withMT = net_woMT.identification(res_woMT)
                meas_attacked.sort()
                ...
                Q = np.array([list(res_woMT['Q'][index]) for index in range(len(res_woMT['Q']))]).T 
                Obs = Q[meas_attacked,:]
                ...
                z_estimada = [net_woMT.meas[idx].h() for idx in meas_attacked]
                ...
                if TP != 0 or FP != 0:
                    Res[str(percent_attacked)][str(scenario)]['Detection'].append(True)
                else:
                    Res[str(percent_attacked)][str(scenario)]['Detection'].append(False)
...
with open('results/detection_wo_MT.json', 'w') as json_file:
