        ...
        while n_simu < 20:
            ...
            try:   
                ...
                for i in range(len(net.meas)):
                   ...
                   is_identified = i in ident_withPSM # Well-identified?
                ...
                z_estimada = [net_withPSM.meas[idx].h() for idx in meas_attacked]
                ...
                x_Huber = res_withPSM['solution'][-1]
...
with open('results/detection_with_PSM.json', 'w') as json_file:
