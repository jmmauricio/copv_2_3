    ...
    for scenario in range(10):
        ...
        while n_simu < 20:
            ...
            if len(solution['solution']) != 0:
                ...
                # Saving the attack
                with open(f'wo MT/case_{scenario}_percent_{percent_attacked}_index_{int(optimal_index)}_{int((optimal_index-int(optimal_index))*1000000)}.json', 'w') as json_file:
